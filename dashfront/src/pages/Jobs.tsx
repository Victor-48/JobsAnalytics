...
export default function Jobs() {
    ...
    const loadData = async (pageToLoad: number) => {
        ...
        try {
            ...
            if (!search.trim()) {
                data = await fetchJobs(actualRemote, actualIndustry, pageToLoad, pageSize);
            } else {
        ...
        <div className="max-w-7xl mx-auto p-6 md:p-10 space-y-8">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select value={industryFilter} onValueChange={setIndustryFilter}>
                            ...
                            <SelectContent>
                                ...
                                {sectors.map((sector: SectorDTO) => (
                                    <SelectItem key={sector.uri} value={sector.name}>
            ...
            {!isLoading && jobs.length === 0 ? (
                <div className="text-center py-20 bg-card rounded-xl border border-dashed border-border flex flex-col items-center justify-center min-h-[300px]">
                    ...
                    <Button variant="outline" className="mt-6" onClick={() => { setSearch(""); setRemoteFilter("all"); setIndustryFilter("all"); }}>
                        Clear Filters
                    </Button>
                </div>
            ) : (
